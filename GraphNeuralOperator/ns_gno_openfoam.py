...
modelSavePath = "model/gno_modelGELU5k.pth"
...
# ===== 4. DATA PREP: VTK PATCH SAMPLER =====
# from openPyMeshParallel import *  # <-- metti la tua classe qui!


# # ====== SELEZIONE PATCH LOCALE (sempre la stessa per tutta la serie temporale) ======
# # Serie temporale patch
# if not load_data:
#     sampler = DataSamplerVTK("VTK/cylinderFlux_*")
#     results, idx_cells = sampler.sample_time_series_patch(
#         N=patch_size, mode=mode, save_path=savePath
#     )
# results, idx_cells = sampler.sample_time_series_patch(
#     N=patch_size,
#     mode="local",
#     center=(10000, 10000),
#     save_path="patch_60k_local.pkl",
# )
...
out_gif = "cylinder_timeseries40k_model5k.gif"
