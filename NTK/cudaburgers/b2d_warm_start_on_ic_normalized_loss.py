...
"""NOTA: oggi, 10/06/2025, è stato un cazzo di casino con le boundary conditions!"""
...
class PINN:
    ...
    def normalize_loss(self, prediction, target, eps=1e-10):
        """
...
bc1_sampler = BCSampler(3, bc1_coord, get_left_bc_from_history, fixed_dims=[1], fixed_values=[x_lb], name='BC1')
bc2_sampler = BCSampler(3, bc2_coord, get_right_bc_from_history, fixed_dims=[1], fixed_values=[x_ub], name='BC2')
bc3_sampler = BCSampler(3, bc3_coord, get_top_bc_from_history, fixed_dims=[2], fixed_values=[yub], name='BC3')
bc4_sampler = BCSampler(3, bc4_coord, get_bottom_bc_from_history, fixed_dims=[2], fixed_values=[ylb], name='BC4')
